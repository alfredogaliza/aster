			...
			<div class="row">
				<div class="col-md-3">
					<div class="row form-group">
						<div class="col-md-12">
							<?php View::includeView('evento/filter')?>							
							<div class="row form-group">
								<div class="col-md-12">
									<button type="button" class="btn btn-success form-control edit" data-href="<?= Controller::route('evento', 'modal') ?>">
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading">
							<a href="#" data-toggle="collapse" data-target="#resultados">Resultados de Eventos <span class="pull-right"><i class="fa fa-users"></i></span></a>
						</div>
						<div class="panel-collapse collapse in" id="resultados">
							<div class="panel-body">								
								<div id="div-eventos"></div>
							</div>
							<div class="panel-footer text-right">
								<ul id="pagination" class="pagination pagination-ajax" data-form="#form-busca" data-target="#div-eventos" style="margin: 0"></ul>
							</div>
						</div>							
					</div>
				</div>

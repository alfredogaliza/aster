...
<body>
	<div class="container">
		...
		<form novalidate id="form-busca" action="<?= Controller::route('tarefa', 'table') ?>" method="GET">
			<input type="hidden" name="status" value="<?= Globals::get('status', 0) ?>" id="status"/>			
			<div class="row">
				<div class="col-md-3">
					<div class="row form-group">
						<div class="col-md-12">
							<?php View::includeView('tarefa/filter')?>							
						</div>
					</div>
				</div>
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading">
							<a href="#" data-toggle="collapse" data-target="#resultados">Resultados de Tarefas <span class="pull-right"><i class="fa fa-users"></i></span></a>
						</div>
						<div class="panel-collapse collapse in" id="resultados">
							...
							<div class="panel-footer text-right">
								<ul id="pagination" class="pagination pagination-ajax" data-form="#form-busca" data-target="#div-tarefas" style="margin: 0"></ul>
							</div>
						</div>							
					</div>
				</div>

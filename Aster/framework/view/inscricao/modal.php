	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Realizar Nova Inscrição</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" id="form" method="post" action="<?php echo Controller::route("inscricao", "gravar")?>">
					<input name="polo_id" type="hidden" value="<?= Globals::get('polo_id')?>" />
					<input name="ano_entrada" type="hidden" value="" />
					<input name="inclusao" type="hidden" value="" />
					<input name="rematricula" type="hidden" value="" />
					...
					<div class="tab-content">
  						<div id="pessoal" class="tab-pane fade in active">
							...
							<div class="row form-group">
								<label class="col-md-2">Polo:</label>
								<div class="col-md-10">
									<label><?= $this->polo->get('quartel')?> (<?= $this->polo->get('endereco')?>)</label>								
								</div>
							</div>
							<div class="row form-group">
							...
							<div class="row form-group">
								...
								<div class="col-md-6">
									<input name="bairro" class="form-control"  type="text" value="<?php echo $this->aluno->get('bairro')?>">
								</div>
							</div>
							<div class="row form-group">
  						...
  						<div id="responsaveis" class="tab-pane fade">
  							...
  							<div class="panel-group" id="group-responsavel"></div>
  						</div>
  					</div>										
					<div class="text-right">
						<button type="button" class="btn btn-danger" data-dismiss="modal"><span class="fa fa-close"></span> Fechar</button>
						<button type="submit" class="btn btn-primary"><span class="fa fa-floppy-o"></span> Salvar e Enviar os Dados</button>
					</div>
				</form>
			</div>
		</div>
...
<script>
	...
	$("#cidade").change(function(){
		$("#bairro").load("<?= Controller::route("ajax","bairro")?>/"+this.value);
	});
